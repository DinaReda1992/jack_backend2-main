				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم</span> -  طلبات الدفع للعضويات</h4>
						</div>
...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="">طلبات الدفع للعضويات</a></li>
						</ul>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">طلبات الدفع للعضويات</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<table class="table datatable-colvis-basic">
							<thead>
								<tr>
									...
									<th>صاحب العضوية</th>
									<th>العضوية المطلوب الترقية لها</th>
									<th>تاريخ الدفع للعضوية</th>
									{{--<th>طريقة الدفع</th>--}}
{{--									<th>المبلغ المحول</th>--}}
									<th>اسم المحول</th>
									<th>اسم البنك المحول منه</th>
									<th>الرقم المرجعي</th>
									<th>صورة التحويل</th>
									{{--<th>ترقية العضوية</th>--}}
								</tr>
...
{{--									<td>{{ @$object->money_transfered }}</td>--}}
									...
									<td>{{ @$object->bank_name ? $object->bank_name: "__________"  }}</td>
									<td>{{ @$object->account_number ? $object->account_number: "__________"  }}</td>
...
{{--									<td>{{ @$object->reference_number ? $object->reference_number : " __________"  }}</td>--}}
									...
									{{--<td>--}}
										{{--@if(@$object->getUser->user_type_id==3)--}}
										{{--<a class="btn btn-success" href="/provider-panel/adv_user_package/{{ $object->user_id }}/{{ $object->package_id }}">ترقية العضوية</a>--}}
										{{--@else--}}
										{{--تم ترقية العضوية--}}
										{{--@endif--}}
									{{--</td>--}}
