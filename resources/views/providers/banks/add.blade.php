...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="/provider-panel/banks">عرض البنوك</a></li>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form method="post" class="form-horizontal" action="{{ isset($object)? '/provider-panel/banks/'.$object->id : '/provider-panel/banks'  }}">
								{!! csrf_field() !!}
									@if(isset($object))
