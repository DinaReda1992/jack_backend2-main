...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="">عرض أنواع الكروت</a></li>
						</ul>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">عرض أنواع الكروت</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<table class="table datatable-colvis-basic">
							...
							@foreach($objects as $object)
								<tr parent_id="{{ $object->id }}">
									...
									<td>
										@if($object->photo)
											<img alt="" width="50" height="50" src="/uploads/{{ $object -> photo }}">
										@else
											لا يوجد صورة بعد
										@endif
									</td>
									<td>{{ $object->hidden == 0  ? 'ظاهر' : 'مخفي'   }}</td>
									<th><a href="/provider-panel/cards/{{ $object->id }}">عرض الكروت</a></th>
									<td align="center" class="center"> <ul class="icons-list">
												 <li class="text-primary-600"><a href="/provider-panel/edit-cards-categories/{{ $object->id }}"><i class="icon-pencil7"></i></a></li>
											</ul>
									</td>
