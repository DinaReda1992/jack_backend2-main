				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم</span> - عرض الرسائل الجديدة</h4>
						</div>
...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="">عرض الرسائل الجديدة</a></li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">عرض الرسائل الجديدة</h5>
							<div class="heading-elements">
								<ul class="icons-list">
							...
							@foreach($objects as $object)
								<tr parent_id="{{ $object->id }}">
									...
									<td align="center" class="center">
										<a href="/provider-panel/message/{{ $object->ticket_id }}">{{ $object->getTicket->name }}</a>
									</td>
									<td align="center" class="center"> <ul class="icons-list">
											<li class="text-danger-600"><a  href="/provider-panel/delete-ticket/{{ $object->ticket_id  }}"><i class="icon-trash"></i></a></li>
