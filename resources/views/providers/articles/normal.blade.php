				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم</span> -  عرض الموضوعات العادية</h4>
						</div>
...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="">عرض الموضوعات العادية</a></li>
						</ul>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">عرض الموضوعات العادية</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<table class="table datatable-colvis-basic">
							...
							@foreach($objects as $object)
								<tr parent_id="{{ $object->id }}">
									...
									<td>
										<a href="/provider-panel/users/adv_slider/{{ $object ->id }}">
											<button type="button" name="button" class="btn {{ $object->adv_slider == 0 ? 'btn-success' : 'btn-warning' }}"> {{ $object->adv_slider == 1 ?  'مسح من الاسلايدر' : 'أضف للاسلايدر' }}</button>
										</a>
