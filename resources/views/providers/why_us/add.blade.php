				...
				<div class="page-header">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="/provider-panel/why_us">عرض لماذا تختارنا</a></li>
				...
				@include('admin.message')
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form method="post" class="form-horizontal" action="{{ isset($object)? '/provider-panel/why_us/'.$object->id : '/provider-panel/why_us'  }}" enctype="multipart/form-data">
								{!! csrf_field() !!}
									@if(isset($object))
