...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="/provider-panel/companies">عرض شركات العقار</a></li>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form enctype="multipart/form-data"  method="post" class="form-horizontal" action="{{ isset($object)? '/provider-panel/companies/'.$object->id : '/provider-panel/companies'  }}">
								{!! csrf_field() !!}
									@if(isset($object))
