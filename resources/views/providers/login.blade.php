		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<!-- Simple login form -->
					<form method="post"  action="/provider-panel/login">
					{!! csrf_field() !!}
						<div class="panel panel-body login-form">
							<div class="text-center">
								{{--<div class="icon-object border-slate-300 text-slate-300"><i class="icon-reading"></i></div>--}}
								<img style="width: 160px;background: #000;"  src="/images/{{ \App\Models\Settings::find(1)->value }}">
								<h5 class="content-group">لوحة تحكم ألمتاجر والمشرفين عليها <small class="display-block">سجل بيانات الدخول لحسابك في الاسفل</small></h5>
							</div>
