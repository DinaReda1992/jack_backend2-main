				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم</span> -    عرض كل الحسابات </h4>
						</div>
...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="">عرض كل الحسابات  </a></li>
						</ul>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">عرض كل الحسابات  </h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<table class="table datatable-colvis-basic">
							...
							<tr>
								...
								<th> المندوب</th>
								<th>رصيد المندوب</th>
								<th>الرصيد بالتفصيل</th>
							</tr>
							</thead>
							<tbody>
							@foreach($objects as $object)
								@php $representative_balance = \App\Models\Balance::where('user_id',$object->user_id)->where('status',0)->sum('price') @endphp
								<tr parent_id="{{ $object->id }}">
									<td>{{ $object->id }}</td>
									<td>{{ $object->getUser->username }}</td>
									<td>
										@php
											if($representative_balance < -\App\Models\Settings::find(12)->value){
                                                 echo "<span style='color:red;direction:ltr'>".$representative_balance." ريال</span>";
                                             }elseif($representative_balance<0){
                                               echo "<span style='color:#d19d07;direction:ltr'>".$representative_balance." ريال</span>";
                                             }else{
                                                 echo "<span style='color:green;direction:ltr'>".$representative_balance." ريال</span>";
                                             }
										@endphp
									</td>
{{--									<td>{{ $object->getUser->username }}</td>--}}
									...
									<td><a href="/provider-panel/get-details/{{ $object->user_id }}"> الرصيد بالتفصيل</a></td>
									{{--<td>--}}
