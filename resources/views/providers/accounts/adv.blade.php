		...
		<div class="page-header">
			<div class="page-header-content">
				<div class="page-title">
					<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم</span> - عرض أصحاب المشاريع</h4>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li class="active"><a href="">عرض أصحاب المشاريع</a></li>
				</ul>
		...
		<!-- Basic example -->
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">عرض أصحاب المشاريع</h5>
					<div class="heading-elements">
						<ul class="icons-list">
				...
				<table class="table datatable-colvis-basic">
					...
					@foreach($objects as $object)
						<tr parent_id="{{ $object->id }}">
							...
							<td>@if($object->user_type_id == 2) مشرف @elseif($object->user_type_id == 3) صاحب مشاريع @else متصفح @endif</td>
							...
							<td>
								@foreach(\App\Models\Packages::all() as $package)
									<a style="margin: 2px" class="btn btn-success" href="/provider-panel/adv_user_package/{{ $object->id }}/{{ $package->id }}">{{ $package->name }}</a>
								@endforeach
							</td>
							<td>
							...
							<td>
								@if($object->package_id!=0)
									<a class="btn btn-success" href="/provider-panel/cancel_package/{{ $object->id }}">الغاء الباقة</a>
								@else
									______
								@endif
							</td>
