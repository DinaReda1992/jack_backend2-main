		...
		<div class="page-header">
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="/provider-panel/branches">عرض الفروع</a></li>
		...
		<!-- Form horizontal -->
			<div class="panel panel-flat">
				...
				<div class="panel-body">
					...
					<form enctype="multipart/form-data" method="post" class="form-horizontal" action="{{ isset($object)? '/provider-panel/branches/'.$object->id : '/provider-panel/branches'  }}">
						{!! csrf_field() !!}
						@if(isset($object))
