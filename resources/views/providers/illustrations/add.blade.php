...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="/provider-panel/illustrations">عرض الشاشات الافتتاحية</a></li>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form enctype="multipart/form-data"  method="post" class="form-horizontal" action="{{ isset($object)? '/provider-panel/illustrations/'.$object->id : '/provider-panel/illustrations'  }}">
								{!! csrf_field() !!}
									@if(isset($object))
