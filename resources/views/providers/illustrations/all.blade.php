...
<td>{{ $object->created_at->format("jS \of F, Y g:i:s a") }}</td>--}}
									<td align="center" class="center"> <ul class="icons-list">
												<li class="text-primary-600"><a href="/provider-panel/illustrations/{{ $object->id }}/edit"><i class="icon-pencil7"></i></a></li>
												<li class="text-danger-600"><a onclick="return false;" object_id="{{ $object->id }}" delete_url="/provider-panel/illustrations/{{ $object->id }}"  class="sweet_warning" href="#"><i class="icon-trash"></i></a></li>
<!-- 												<li class="text-teal-600"><a href="#"><i class="icon-cog7"></i></a></li> -->
			...
			<script type="text/javascript">
                ...
                $(document).ready(function () {
                    $(document).on('change','.illustrations_order',function () {
                        ...
                        var order = $(this).val();
                        $.get('/provider-panel/save_order_illustrations/'+ illustrations_id + "/" +order,function (data) {
			...
			<script type="text/javascript">
				...
				function updateOrder(data) {
					console.log(data);
					$.ajax({
						url:"/provider-panel/change-sort-illustrations",
						type:'post',
						data:{position:data},
						success:function(){
						}
