					...
					@foreach($objects as $object)
						<tr parent_id="{{ $object->id }}">
							...
							<td align="center" class="center"> <ul class="icons-list">
									<li class="text-primary-600"><a href="/provider-panel/banners/{{ $object->id }}/edit"><i class="icon-pencil7"></i></a></li>
									{{--@if($object->id>2)--}}
									<li class="text-danger-600"><a onclick="return false;" object_id="{{ $object->id }}" delete_url="/provider-panel/banners/{{ $object->id }}"  class="sweet_warning" href="#"><i class="icon-trash"></i></a></li>
									{{--@endif--}}
...
{{--	<script src="https://code.jquery.com/jquery-1.12.4.js"></script>--}}
	...
	<script type="text/javascript">
		...
		function updateOrder(data) {
			console.log(data);
			$.ajax({
				url:"/provider-panel/change-sort-banners",
				type:'post',
				data:{position:data},
				success:function(){
				}
