		...
		<div class="page-header">
			<div class="page-header-content">
				<div class="page-title">
					...
					@if(isset($object))
						<a  href="/provider-panel/add-product/{{ $object->id }}" class="btn btn-primary pull-right">أضف منتج</a>
						<a  href="/provider-panel/all-products/{{ $object->id }}" class="btn btn-primary pull-right" style="margin-left: 5px">عرض المنتجات</a>
					@endif
					</h4>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="/provider-panel/projects">عرض المشاريع</a></li>
		...
		<!-- Form horizontal -->
			<div class="panel panel-flat">
				...
				<div class="panel-body">
					...
					<form enctype="multipart/form-data" method="post" class="form-horizontal" action="{{ isset($object)? '/provider-panel/projects/'.$object->id : '/provider-panel/projects'  }}">
						{!! csrf_field() !!}
						@if(isset($object))
									...
									<div class="col-lg-10">
										@foreach( \App\Models\ProjectPhotos::where('project_id',$object->id)->get() as $photo)
											<div align="center" style="height: 75px;width: 100px;float: right;margin-right: 5px">
												...
												<a href="/provider-panel/delete-photo-project/{{ $photo->id }}" style="text-align: center">حذف</a>
											</div>
										@endforeach
									</div>
