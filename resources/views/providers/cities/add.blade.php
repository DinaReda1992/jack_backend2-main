...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="/provider-panel/cities">عرض المدن</a></li>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form method="post" class="form-horizontal" action="{{ isset($object)? '/provider-panel/cities/'.$object->id : '/provider-panel/cities'  }}">
								{!! csrf_field() !!}
									@if(isset($object))
								...
								<fieldset class="content-group">
								   <div class="form-group{{ $errors->has('state_id') ? ' has-error' : '' }}">
									...
									<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
										<label class="control-label col-lg-2">أدخل اسم المدينة</label>
										<div class="col-lg-10">
										<input type="text" name="name" value="{{ isset($object) ? $object->name  : old('name')  }}" class="form-control" placeholder="أدخل اسم المدينة">
										@if ($errors->has('name'))
		                                    <span class="help-block">
