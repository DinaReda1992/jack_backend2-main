				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم</span> - عرض الموديلات</h4>
						</div>
...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="">عرض الموديلات</a></li>
						</ul>
...
{{--									<td>{{ $object->created_at->format("jS \of F, Y g:i:s a") }}</td>--}}
									{{--<td><input value="{{ $object->orders }}" type="text" class="type_order" type_id="{{ $object->id }}" style="width: 50px;padding: 5px;text-align: center"></td>--}}
										...
										<td align="center" class="center"> <ul class="icons-list">
												<li class="text-primary-600"><a href="/provider-panel/carsmodels/{{ $object->id }}/edit"><i class="icon-pencil7"></i></a></li>
												<li class="text-danger-600"><a onclick="return false;" object_id="{{ $object->id }}" delete_url="/provider-panel/carsmodels/{{ $object->id }}"  class="sweet_warning" href="#"><i class="icon-trash"></i></a></li>
			...
			<script type="text/javascript">
                ...
                $(document).ready(function () {
                    $(document).on('change','.type_order',function () {
                        ...
                        var order = $(this).val();
                        $.get('/provider-panel/save_order_type/'+ type_id + "/" +order,function (data) {
