		...
		<div class="page-header">
			<div class="page-header-content">
				<div class="page-title">
					<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم</span> -    عرض العملاء </h4>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li class="active"><a href="">عرض العملاء  </a></li>
				</ul>
		...
		<!-- Basic example -->
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">عرض العملاء  </h5>
					<div class="heading-elements">
						<ul class="icons-list">
...
{{--							<td>@if($object->store==1) عضوية متجر عادية @else عضوية عادية @endif</td>--}}
...
{{--							<td>--}}
{{--								{{ \App\Models\Orders::where('user_id',$object->id)->where('status',2)->count() }}--}}
...
{{--								<a style="margin: 5px" class="btn btn-success" href="/provider-panel/adv_user_package/{{ $object->id }}/{{ $package->id }}">{{ $package->name }}</a>--}}
{{--							@endforeach--}}
{{--							</td>--}}
