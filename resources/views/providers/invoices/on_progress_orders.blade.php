						...
						<table class="table datatable-colvis-basic">
							...
							@foreach($objects as $object)
								<tr parent_id="{{ $object->id }}">
									...
									<td><a href="/provider-panel/users/{{ $object->user_id  }}/edit" target="_blank">{{ $object->getUser ? $object->getUser->full_name()  : '_________' }}</a></td>
									<td><a href="/provider-panel/states/{{ $object->state_id  }}/edit" target="_blank">{{ $object->getState ? $object->getState->name  : 'لم يحدد مدينة' }}</a></td>
									<td>
									...
									<td>
										<a href="/provider-panel/finish_order/{{ $object ->id }}">
