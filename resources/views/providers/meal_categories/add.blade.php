		...
		<div class="page-header">
			<div class="page-header-content">
				<div class="page-title">
					<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم </span> - {{ isset($object)? 'تعديل':'إضافة' }} قسم رئيسي</h4>
				</div>
				<div class="heading-elements">
					<div class="heading-btn-group">
						<a href="/provider-panel/meal-categories"><button type="button" class="btn btn-success" name="button">  عرض الاقسام</button></a>
					</div>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="/provider-panel/categories">عرض الاقسام</a></li>
					<li class="active">{{ isset($object)? 'تعديل':'إضافة' }} قسم رئيسي</li>
				</ul>
		...
		<!-- Form horizontal -->
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">{{ isset($object)? 'تعديل':'إضافة' }} قسم رئيسي </h5>
					<div class="heading-elements">
						<ul class="icons-list">
				...
				<div class="panel-body">
					...
					<form enctype="multipart/form-data" method="post" class="form-horizontal" action="{{ isset($object)? '/provider-panel/meal-categories/'.$object->id : '/provider-panel/meal-categories'  }}">
						{!! csrf_field() !!}
						@if(isset($object))
