			...
			<div class="page-header-content">
				...
				<div class="heading-elements">
					<div class="heading-btn-group">
						<a href="/provider-panel/restaurants/create"><button type="button" class="btn btn-success" name="button">  اضافة مطعم</button></a>
					</div>
				</div>
				...
				<table class="table datatable-colvis-basic">
					...
					@foreach($objects as $object)
						<tr parent_id="{{ $object->id }}">
							...
							<td>{{ $object->mealMenu?$object->mealMenu->name:'لم يتم تعيينه' }}</td>
							<?php
							$status='';
							$color='';
							if ($object->stop=='1'){
							...
							<td align="center" class="center"> <ul class="icons-list">
									<li class="text-primary-600"><a href="/provider-panel/restaurants/{{ $object->id }}/edit"><i class="icon-pencil7"></i></a></li>
									@if($object->approved !=0 && $object->approved!=3)
									<li class="text-teal-600"><a href="/provider-panel/stop_open_restaurant/{{$object->id}}"><i class="fa fa-power-off" style="font-size: 17px;
