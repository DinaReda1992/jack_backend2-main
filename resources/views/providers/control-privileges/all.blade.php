...
@include('admin.message')
						...
						<table class="table table-bordered">
							...
							@foreach($objects as $object)
								<tr parent_id="{{ $object->id }}">
									...
									<td><a  href="/provider-panel/show-privileges/{{ $object -> id }}"> إخفاء </a></td>

									{{--<td><a target="_blank" href="/provider-panel/privileges/{{ $object -> id }}/edit"> عرض </a></td>--}}
									<td align="center" class="center"> <ul class="icons-list">
												 <li class="text-primary-600"><a href="/provider-panel/privileges/{{ $object -> id }}/edit"><i class="icon-pencil7"></i></a></li>
										{{--<li class="text-danger-600"><a onclick="return false;" object_id="{{ $object->id }}" delete_url="/provider-panel/privileges/{{ $object->id }}"  class="sweet_warning" href="#"><i class="icon-trash"></i></a></li>--}}
			...
			<script type="text/javascript">
				...
				function updateOrder(data) {
					console.log(data);
					$.ajax({
						url:"/provider-panel/change-sort",
						type:'post',
						data:{position:data},
						success:function(){
						}
