				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم</span> - عرض الماركات</h4>
						</div>
...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="">عرض الماركات</a></li>
						</ul>
						...
						<table class="table datatable-colvis-basic">
							<thead>
								<tr>
									...
									{{--<th>القسم الرئيسي</th>--}}
									<th>الماركة بالعربية</th>
									{{--<th>صورة الماركة</th>--}}
									<th>الماركة بالانجليزية</th>
...
{{--									<td>{{ $object->created_at->format("jS \of F, Y g:i:s a") }}</td>--}}
									...
									<td align="center" class="center"> <ul class="icons-list">
												<li class="text-primary-600"><a href="/provider-panel/cars/{{ $object->id }}/edit"><i class="icon-pencil7"></i></a></li>
												<li class="text-danger-600"><a onclick="return false;" object_id="{{ $object->id }}" delete_url="/provider-panel/cars/{{ $object->id }}"  class="sweet_warning" href="#"><i class="icon-trash"></i></a></li>
