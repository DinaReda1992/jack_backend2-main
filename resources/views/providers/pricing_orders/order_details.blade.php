        ...
        <div class="page-header">
            <div class="page-header-content">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a href="/provider-panel/pricing-orders">
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li><a href="/provider-panel/pricing-orders">عرض طلبات التسعير</a></li>
...
$pan_count=0;
                                                    ...
                                                    @foreach($object->parts as $part_)
                                                        <li class="{{$tab_count==0?'active':''}}"><a
                                                                    style="color:{{$part_->my_offer->first()?'#4bda03':'#000'}}"
                                                ...
                                                <form method="post" class="form-horizontal"
                                                      action="/provider-panel/add_pricing_offers/{{$object->id}}">
                                                    {!! csrf_field() !!}
                                                                            ...
                                                                            <div class="my-offer">
                                                                                <div class="post">
                                                                                    <div class="user-block">
                                                                                        <img class="img-circle img-bordered-sm" src="/uploads/{{ auth()->user()->provider->photo?:'placeholder.png' }}" alt="user image">
                                                                                        <span class="username">
                          <a href="#">{{ auth()->user()->provider->username }}</a>

                        </span>
                                                                                        <span class="description">{{@$part->my_offer->first()->created_at->diffForHumans()}}</span>
                                                                                    </div><!-- /.user-block -->
                                                                                    <div class="form-group col-md-6">
                                                                                        <label class="control-label col-lg-12">الخامة</label>
                                                                                        <div class="col-lg-10">
                                                                                            <p class="form-control" >{{@$part->my_offer->first()->manufactureType->name}}</p>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group col-md-6">
                                                                                        <label class="control-label col-lg-12">وقت التحضير</label>
                                                                                        <div class="col-lg-10">
                                                                                            <p class="form-control" >{{@$part->my_offer->first()->prepare_time}}</p>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group col-md-6">
                                                                                        <label class="control-label col-lg-12">القطع المتاحة</label>
                                                                                        <div class="col-lg-10">
                                                                                            <p class="form-control" >{{@$part->my_offer->first()->available_quantity}}</p>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group col-md-6">
                                                                                        ...
                                                                                        <div class="col-lg-10">
                                                                                            <div class="col-md-9">
                                                                                            <p class="form-control" >{{@$part->my_offer->first()->price}} ريال </p>
                                                                                            </div>
                                                                                            <div class="col-md-3">
                                                                                    ...
                                                                                    <div class="form-group col-md-6">
                                                                                        ...
                                                                                        <div class="col-lg-10">
                                                                                            <p class="form-control" >{{$part->my_offer->first()->price * @$part->my_offer->first()->available_quantity}}</p>
                                                                                        </div>
                                                                                    </div>
...
{{--                                                                                        <div class="col-lg-10">--}}
{{--                                                                                            <p class="form-control" >{{@$part->my_offer->first()->PricingOrderType->name}}</p>--}}
{{--                                                                                        </div>--}}
{{--                                                                                    </div>--}}
                                                                                    <div class="form-group col-md-6">
                                                                                        <label class="control-label col-lg-12">بلد الصنع</label>
                                                                                        <div class="col-lg-10">
                                                                                            <p class="form-control" >{{@$part->my_offer->first()->manufacture_country}}</p>
                                                                                        </div>
                                                                                    </div>
{{--                                                                                    <div class="form-group col-md-6">--}}
{{--                                                                                        <label class="control-label col-lg-12">الماركة</label>--}}
{{--                                                                                        <div class="col-lg-10">--}}
{{--                                                                                            <p class="form-control" >{{@$part->my_offer->first()->brand}}</p>--}}
{{--                                                                                        </div>--}}
{{--                                                                                    </div>--}}
                                                                        ...
                                                                        @elseif(!$part->my_offer->first() && $object->status==0)
