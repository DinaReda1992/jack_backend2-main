				...
				<div class="page-header">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="/provider-panel/steps">عرض الخطوات</a></li>
				...
				@include('admin.message')
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form method="post" class="form-horizontal" action="{{ isset($object)? '/provider-panel/steps/'.$object->id : '/provider-panel/steps'  }}" enctype="multipart/form-data">
								{!! csrf_field() !!}
									@if(isset($object))
