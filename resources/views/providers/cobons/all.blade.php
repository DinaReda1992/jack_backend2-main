				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم</span> - عرض كوبونات الخصم</h4>
						</div>
...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="">عرض كوبونات الخصم</a></li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">عرض كوبونات الخصم</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<table class="table datatable-colvis-basic">
							...
							@foreach($objects as $object)
								<tr parent_id="{{@$object->id }}">
									...
									<td>{{ \App\Models\Orders::where('cobon',$object->code)->whereIn('status',[1,2,4])->count() }}</td>
...
{{--									<td>{{@$object->created_at->format("jS \of F, Y g:i:s a") }}</td>--}}
									...
									<td align="center" class="center"> <ul class="icons-list">
												<li class="text-primary-600"><a href="/provider-panel/cobons/{{@$object->id }}/edit"><i class="icon-pencil7"></i></a></li>
												<li class="text-danger-600"><a onclick="return false;" object_id="{{@$object->id }}" delete_url="/provider-panel/cobons/{{@$object->id }}"  class="sweet_warning" href="#"><i class="icon-trash"></i></a></li>
