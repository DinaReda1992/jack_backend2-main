		...
		<div class="page-header">
			<div class="page-header-content">
				...
				<div class="heading-elements">
					<div class="heading-btn-group">
						<a href="/provider-panel/damage-estimates"><button type="button" class="btn btn-success" name="button">  عرض طلبات الخدمات</button></a>
					</div>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="/provider-panel/damage-estimates">عرض طلبات الخدمات</a></li>
														...
														<div class="modal fade" id="acceptModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
															<div class="modal-dialog" role="document">
																<div class="modal-content">
																	...
																	<form method="post" action="/provider-panel/add_damage_offer/{{$object->id}}">
																		{!! csrf_field() !!}
