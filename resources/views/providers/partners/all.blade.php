...
{{--									<td>{{ $object->created_at->format("jS \of F, Y g:i:s a") }}</td>--}}
									...
									<td align="center" class="center"> <ul class="icons-list">
												<li class="text-primary-600"><a href="/provider-panel/partners/{{ $object->id }}/edit"><i class="icon-pencil7"></i></a></li>
												<li class="text-danger-600"><a onclick="return false;" object_id="{{ $object->id }}" delete_url="/provider-panel/partners/{{ $object->id }}"  class="sweet_warning" href="#"><i class="icon-trash"></i></a></li>
