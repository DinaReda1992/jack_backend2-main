		...
		<div class="page-header">
			<div class="page-header-content">
				<div class="page-title">
					<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم </span> - {{ isset($object)? 'تعديل':'إضافة' }} نوع سيارة </h4>
				</div>
				<div class="heading-elements">
					<div class="heading-btn-group">
						<a href="/admin-panel/makes"><button type="button" class="btn btn-success" name="button">  عرض الانواع</button></a>
					</div>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="/admin-panel/makes">عرض الانواع</a></li>
					<li class="active">{{ isset($object)? 'تعديل':'إضافة' }} نوع سيارة </li>
				</ul>
		...
		<!-- Form horizontal -->
			<div class="panel panel-flat">
				...
				<div class="panel-body">
					...
					<form enctype="multipart/form-data" method="post" class="form-horizontal" action="{{ isset($object)? '/admin-panel/makes/'.$object->id : '/admin-panel/makes'  }}">
						{!! csrf_field() !!}
						@if(isset($object))
...
{{--							</div>--}}
							...
							<div class="form-group{{ $errors->has('publish') ? ' has-error' : '' }}">
								<label class="control-label col-lg-2">تفعيل النوع </label>
								<div class="col-md-10">
									<p><input type="checkbox" class="js-switch" name="stop" {{ isset($object) ? ($object->stop==0?'checked':'')  :'checked'  }} />  </p>
								</div>
							</div>
							<div class="form-group{{ $errors->has('is_special_order') ? ' has-error' : '' }}">
								<label class="control-label col-lg-2">تفعيل فى طلبات التسعير والصيانة </label>
								<div class="col-md-10">
									<p><input type="checkbox" class="js-switch1" name="is_special_order" {{ isset($object) ? ($object->is_special_order==0?'':'checked')  :'checked'  }} />  </p>
								</div>
							</div>
						...
						@if(@!$object->parent)
														...
														@if(isset($object)&&$object->image)
															<div class="form-group">
																...
																<div class="col-lg-10">
																	<img alt="" width="100" height="75" src="/uploads/{{ $object  -> image }}">
																</div>
