				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">{{__('dashboard.dashboard')}}</span> - عرض الأرصدة المضافة للعضو</h4>
						</div>
...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="">عرض الأرصدة المضافة للعضو</a></li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">عرض الأرصدة المضافة لعضو</h5>
							<div class="heading-elements">
								<ul class="icons-list">
							...
							@foreach($objects as $object)
								<tr parent_id="{{ $object->id }}">
									...
									<td>
										...
										@else
											<span class="text text-danger">{{ $object->price }} {{__('dashboard.sar')}}</span>
										@endif
									</td>
