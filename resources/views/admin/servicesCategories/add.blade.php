        ...
        <div class="page-header">
            <div class="page-header-content">
                <div class="page-title">
                    <h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم </span>
                        - {{ isset($object)? 'تعديل':'إضافة' }} قسم مورد</h4>
                </div>
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a href="/admin-panel/supplierCategories">
                            <button type="button" class="btn btn-success" name="button"> عرض اقسام الموردين</button>
                        </a>
                    </div>
                </div>
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li><a href="/admin-panel/supplierCategories">عرض اقسام الموردين</a></li>
        ...
        <!-- Form horizontal -->
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">{{ isset($object)? 'تعديل':'إضافة' }} قسم مورد </h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                ...
                <div class="panel-body">
                    ...
                    <form enctype="multipart/form-data" method="post" class="form-horizontal"
                          action="{{ isset($object)? '/admin-panel/supplierCategories/'.$object->id : '/admin-panel/supplierCategories'  }}">
                        {!! csrf_field() !!}
                        @if(isset($object))
