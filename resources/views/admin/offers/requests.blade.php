        ...
        <div class="page-header">
            <div class="page-header-content">
                <div class="page-title">
                    <h4><i class="icon-arrow-right6 position-left"></i> <span
                        ...
                        {{ __('dashboard.view_requests_offers') }}
                    </h4>
                </div>
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a href="/pharmacy-panel/offers/request-offer">
                            <button type="button" class="btn btn-success" name="button"> {{__('dashboard.add_new')}}</button>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><a href="">{{ __('dashboard.view_requests_offers') }}</a></li>
                </ul>
                <div style=" text-align: center;">
                    <ul class="nav nav-tabs" role="tablist">
                        <li
                            class="{{ !app('request')->input('status') || app('request')->input('status') == 'all' ? 'active' : '' }}">
                            <a href="/pharmacy-panel/offers/requests"> {{ __('dashboard.all') }}</a>
                        </li>
                        <li
                            class="{{ app('request')->input('status') && app('request')->input('status') == 'waiting' ? 'active' : '' }}">
                            <a href="/pharmacy-panel/offers/requests?status=waiting"> {{ __('dashboard.waiting') }}
                            </a>
                        </li>
                        <li
                            class="{{ app('request')->input('status') && app('request')->input('status') == 'approved' ? 'active' : '' }}">
                            <a href="/pharmacy-panel/offers/requests?status=approved"> {{ __('dashboard.accepted') }}
                            </a>
                        </li>

                        <li
                            class="{{ app('request')->input('status') && app('request')->input('status') == 'refused' ? 'active' : '' }}">
                            <a href="/pharmacy-panel/offers/requests?status=refused"> {{ __('dashboard.refused') }}
                            </a>
                        </li>
        ...
        <div class="content">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">{{ __('dashboard.view_requests_offers') }}</h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
