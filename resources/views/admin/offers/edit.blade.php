...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="page-header">
            <div class="page-header-content">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a href="/admin-panel/offers"><button type="button" class="btn btn-success" name="button">
                                {{ __('dashboard.view_offers') }}</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{ __('dashboard.edit') }} {{ __('dashboard.offer') }} </li>
                </ul>
            </div>
        ...
        <div class="content">
            ...
            <div>
                <update_offer :offer_types="{{ $offer_types }}" :data="{{ $object }}" />
