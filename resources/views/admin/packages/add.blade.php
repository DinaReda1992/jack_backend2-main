				...
				<div class="page-header">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="/admin-panel/packages">عرض الباقات</a></li>
				...
				@include('admin.message')
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form method="post" class="form-horizontal" action="{{ isset($object)? '/admin-panel/packages/'.$object->id : '/admin-panel/packages'  }}" enctype="multipart/form-data">
								{!! csrf_field() !!}
									@if(isset($object))
