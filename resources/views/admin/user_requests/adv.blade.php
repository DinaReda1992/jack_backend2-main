		...
		<div class="page-header">
			<div class="page-header-content">
				<div class="page-title">
					<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم</span> - عرض المتاجر {{app('request')->input('type')=='deleted'?' المحذوفة':''}}</h4>
				</div>
						...
						<ul class="icons-list">
							<li>
								@if(app('request')->input('type')=='deleted')
									<a style="color: blue" href="/admin-panel/provider-users" > المفعلة <i class="fa fa-gift"></i></a>
