        ...
        <div class="page-header">
            <div class="page-header-content">
                <div class="page-title">
                    <h4><i class="icon-arrow-right6 position-left"></i> <span
                        ...
                        {{ __('dashboard.view_supervisors') }} </h4>
                </div>
            </div>
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><a href="">{{ __('dashboard.view_supervisors') }} </a></li>
                </ul>
            </div>
        </div>
        <!-- /page header -->
        ...
        <div class="content">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">{{ __('dashboard.view_supervisors') }} </h5>
                    ...
                    <tbody>
                        @foreach ($objects as $object)
                            <tr parent_id="{{ $object->id }}">
                                ...
                                <td>
                                    @if ($object->privilegesGroup)
                                        {{ $object->privilegesGroup->name }}
                                    @elseif($object->user_type_id == 3)
                                        صاحب مشاريع
                                    @else
                                        متصفح
                                    @endif
                                ...
                                <td>
                                    {!! $object->activate == 1
                                        ? __('dashboard.active')
                                        : '<a href="/admin-panel/users/active_user/' .
                                            $object->id .
                                            '">
                                ...
                                <td align="center" class="center">
                                    <ul class="icons-list">
                                        <li class="text-primary-600"><a
                                                href="/admin-panel/users/{{ $object->id }}/edit"><i
                                                    class="icon-pencil7"></i></a></li>
                                        <li class="text-danger-600"><a onclick="return false;"
                                                object_id="{{ $object->id }}"
                                                delete_url="/admin-panel/users/{{ $object->id }}" class="sweet_warning"
