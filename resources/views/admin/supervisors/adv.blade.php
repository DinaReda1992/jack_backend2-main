		...
		<div class="page-header">
			<div class="page-header-content">
				<div class="page-title">
					<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">{{__('dashboard.dashboard')}}</span> - عرض أصحاب المشاريع</h4>
				</div>
				...
				<table class="table datatable-colvis-basic text-center">
					...
					@foreach($objects as $object)
						<tr parent_id="{{ $object->id }}">
							...
							{{--<td>--}}
							{{--{!!   $object->activate == 1 ? "مفعل" : '<a href="/admin-panel/users/active_user/'.$object->id.'">--}}
							...
							<td>
								<a href="/admin-panel/users/block_user/{{ $object ->id }}">
							...
							<td align="center" class="center">
								<ul class="icons-list">
									...
									<li class="text-danger-600"><a onclick="return false;" object_id="{{ $object->id }}" delete_url="/admin-panel/users/{{ $object->id }}"  class="sweet_warning" href="#"><i class="icon-trash"></i></a></li>
