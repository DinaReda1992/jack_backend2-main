...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <form enctype="multipart/form-data" method="post" class="form-horizontal" action="/admin-panel/settings">
                {!! csrf_field() !!}

                <?php foreach(\App\Models\Settings::orderBy('orders','ASC')->groupBy('type')->get() as  $value){ ?>
                <!-- Form horizontal -->
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                        ...
                        <?php foreach (\App\Models\Settings::where('type', '=', $value -> type)->where('hidden',0) -> get() as  $value1){ ?>
                        <fieldset class="content-group">
                            ...
                            @if ($value1->id == 1)
                                ...
                                <div class="form-group">
                                    ...
                                    @if (!empty($value1->value))
                                        <div class="col-lg-5">
                                            <img height="100px" src="/images/{{ $value1->value }}" alt="" />
                                            <span class="help-block">
                            ...
                            @elseif($value1->option_name == 'logo_icon')
                                <div class="form-group">
                                    <label class="control-label col-lg-2">{{ $value1->name }}</label>
                                    <div class="col-lg-5">
                                        <input type="file" name="logoicon" value="" class="form-control">
                            ...
                            @elseif($value1->option_name == 'header')
                                <div class="form-group">
                                    <label class="control-label col-lg-2">{{ $value1->name }}</label>
                                    <div class="col-lg-5">
                                        <input type="file" name="header" value="" class="form-control">
                            ...
                            @elseif($value1->option_name == 'footer')
                                <div class="form-group">
                                    <label class="control-label col-lg-2">{{ $value1->name }}</label>
                                    <div class="col-lg-5">
                                        <input type="file" name="footer" value="" class="form-control">
                            ...
                            @elseif($value1->option_name == 'middle_photo')
                                <div class="form-group">
                                    <label class="control-label col-lg-2">{{ $value1->name }}</label>
                                    <div class="col-lg-5">
                                        <input type="file" name="middle_photo" value="" class="form-control">
                                    ...
                                    @if (!empty($value1->value))
                                        <div class="col-lg-5">
                                            <img height="100px" src="/uploads/{{ $value1->value }}" alt="" />
                                            <span class="help-block">
                                                <strong>الصورة الحالية</strong>
                                            </span>
                            ...
                            @elseif($value1->input_type == 'radio')
                                <div class="form-group">
                                    <label class="control-label col-lg-2">{{ $value1->name }} </label>
                                    <div class="col-lg-10">
