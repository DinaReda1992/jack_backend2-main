		...
		<div class="page-header">
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="/admin-panel/cards_categories">عرض أقسام الكروت</a></li>
		...
		<!-- Form horizontal -->
			<div class="panel panel-flat">
				...
				<div class="panel-body">
					...
					<form enctype="multipart/form-data" method="post" class="form-horizontal" action="/admin-panel/edit-cards-categories/{{ $object->id }}">
						{!! csrf_field() !!}
						{{--@if(isset($object))--}}
