						...
						<table class="table datatable-colvis-basic">
							...
							@foreach($objects as $object)
								<tr parent_id="{{ $object->id }}">
									...
									<th><a href="/admin-panel/cards/{{ $object->id }}">عرض الكروت</a></th>
									<td align="center" class="center"> <ul class="icons-list">
												 <li class="text-primary-600"><a href="/admin-panel/edit-cards-categories/{{ $object->id }}"><i class="icon-pencil7"></i></a></li>
											</ul>
									</td>
