									...
									<div class="modal-content">
										<div class="modal-header">
											...
											<div class="modal-footer">
												...
												<a href="/admin-panel/approve_reservation/{{ $object ->id }}" type="submit" class="btn btn-primary">نعم</a>
											</div>
									</div>
								</div>
							</div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '#provider_id', function (e) {
                ...
                window.location.href = "/admin-panel/reservations?type=new&&" + "provider_id=" + provider_id
            });
