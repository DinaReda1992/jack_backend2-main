...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="/hall-panel/users">عرض الاعضاء</a></li>
	...
	@if($message->sender_id == $order->user_id)
									<li class="media reversed">
										<div class="media-body">
											...
											<span class="media-annotation display-block mt-10">{{ $message->created_at }} ( <a href="/hall-panel/all-users/{{ $message->sender_id }}/edit">{{ $message->getSenderUser->username }}</a> )</span>
										</div>

										<div class="media-right">
											<a href="/hall-panel/all-users/{{ $message->sender_id }}/edit">
	...
	@else
											<li class="media">
												<div class="media-left">
													<a href="/hall-panel/all-users/{{ $message->reciever_id }}/edit">
												...
												<div class="media-body">
													<div class="media-content">{{ $message->message }}</div>
													<span class="media-annotation display-block mt-10">{{ $message->created_at }} ( <a href="/hall-panel/all-users/{{ $message->reciever_id }}/edit">{{ $message->getRecieverUser->username }}</a> )</span>
												</div>
											</li>
