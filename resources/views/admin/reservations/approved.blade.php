        ...
        <div class="page-header">
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><a href="">عرض الحجوزات المعتمدة</a></li>
                </ul>
        ...
        <!-- Basic example -->
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">عرض الحجوزات المعتمدة</h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                            ...
                            <div class="modal fade" id="myModal{{ $object->id }}555" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form method="get" action="/admin-panel/cancel_reservation/{{ $object ->id }}">
                                            <div class="modal-body">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '#provider_id', function (e) {
                ...
                window.location.href = "/admin-panel/reservations?type=approved&&" + "provider_id=" + provider_id
            });
