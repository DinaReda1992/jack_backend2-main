				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم</span> -  عرض الاعلانات المميزة</h4>
						</div>
...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="">عرض الاعلانات المميزة</a></li>
						</ul>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">عرض الاعلانات المميزة</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<table class="table datatable-colvis-basic">
							...
							@foreach($objects as $object)
								<tr parent_id="{{ $object->id }}">
									...
									<td>
										<a href="/hall-panel/users/adv_slider/{{ $object ->id }}">
									...
									<td>
										<a href="/hall-panel/users/adv_ads/{{ $object ->id }}">
									...
									<td align="center" class="center"> <ul class="icons-list">
												...
												<li class="text-danger-600"><a onclick="return false;" object_id="{{ $object->id }}" delete_url="/hall-panel/ads/{{ $object->id }}"  class="sweet_warning" href="#"><i class="icon-trash"></i></a></li>
