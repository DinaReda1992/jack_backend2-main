				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم</span> -  عرض طلبات الفحص التي تم دفع تكلفتها </h4>
						</div>
...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							<li><a href="/hall-panel/index"><i class="icon-home2 position-left"></i> الرئيسية</a></li>
						...
						<table class="table datatable-colvis-basic">
							...
							@foreach($objects as $object)
								<tr parent_id="{{ $object->id }}">
									...
									<td><a href="/hall-panel/users/{{ $object->user_id  }}/edit" target="_blank">{{ $object->getUser ? $object->getUser->full_name()  : '_________' }}</a></td>
									<td><a href="/hall-panel/states/{{ $object->state_id  }}/edit" target="_blank">{{ $object->getState ? $object->getState->name  : 'لم يحدد مدينة' }}</a></td>
									<td>
										<a href="/hall-panel/on_progress_order/{{ $object ->id }}">
									...
									{{--<td align="center" class="center"> <ul class="icons-list">--}}
												...
												{{--<li class="text-danger-600"><a onclick="return false;" object_id="{{ $object->id }}" delete_url="/hall-panel/projects/{{ $object->id }}"  class="sweet_warning" href="#"><i class="icon-trash"></i></a></li>--}}
