<table class="table table-bordered">
    ...
    @foreach($objects as $object)
        <tr parent_id="{{ $object->id }}">
            ...
            {{--            @endif--}}
            <td><a href="/hall-panel/all-users/{{ $object->user_id }}/edit">{{ @$object->getUser->username }}</a></td>
            @if($type == 1 || $type== 2)
                <td>
                    <a href="/hall-panel/all-users/{{ $object->representative_id }}/edit">{{ @$object->getRepresentative ?  @$object->getRepresentative->username : '___________' }}</a>
                </td>
            @endif
            ...
            {{--</div>--}}
            {{--<form method="get" action="/hall-panel/cancel_order/{{ $object ->id }}">--}}
            ...
            {{--</td>--}}
            @if($type == 1 || $type== 2)
                <td><a href="/hall-panel/order-messages/{{ $object->id }}">عرض الرسائل
