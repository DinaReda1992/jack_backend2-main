            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h4><i class="icon-arrow-right6 position-left"></i> <span
                        ...
                        {{ __('dashboard.types_of_activity') }}</h4>
                </div>
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a href="/admin-panel/client_types/create"><button type="button" class="btn btn-success"
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a href="">{{ __('dashboard.types_of_activity') }}</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">{{ __('dashboard.types_of_activity') }}</h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                ...
                <table class="table datatable-colvis-basic text-center">
                    <thead>
                        <tr>
                            ...
                            <th>{{ __('dashboard.activity_name_ar') }}</th>
                            <th>{{ __('dashboard.activity_name_en') }}</th>
                                ...
                                <td align="center" class="center">
                                    <ul class="icons-list">
                                        <li class="text-primary-600"><a
                                                href="/admin-panel/client_types/{{ $object->id }}/edit"><i
                                                    class="icon-pencil7"></i></a></li>
                                        <li class="text-danger-600"><a onclick="return false;"
                                                object_id="{{ $object->id }}"
                                                delete_url="/admin-panel/client_types/{{ $object->id }}"
