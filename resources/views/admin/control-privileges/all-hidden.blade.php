...
<!-- 						</ul> -->
					...
					<div style=" text-align: center;" >
						<ul class="nav nav-tabs" role="tablist">
							<li role="presentation" class="{{app('request')->input('type')!='hall' ?"active":""}}"  ><a href="/admin-panel/privileges-hidden?type=admin">قوائم الادارة</a></li>
							<li role="presentation"  class="{{app('request')->input('type')=='hall'?"active":""}}" ><a href="/admin-panel/privileges-hidden?type=hall">قوائم القاعات</a></li>
						...
						<table class="table table-bordered">
							...
							@foreach($objects as $object)
								<tr parent_id="{{ $object->id }}">
									...
									<td><a  href="/admin-panel/show-privileges/{{ $object -> id }}"> اظهار </a></td>
