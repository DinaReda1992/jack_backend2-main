...
@section('content')
        ...
        <div class="page-header">
            <div class="page-header-content">
                <div class="page-title">
                    <h4><i class="icon-arrow-right6 position-left"></i> <span
                        ...
                        {{ __('dashboard.view_sort_products') }} </h4>
                </div>
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a href="/admin-panel/products/create"><button type="button" class="btn btn-success" name="button">
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><a href="">{{ __('dashboard.view_sort_products') }} </a></li>
                </ul>
            </div>
        </div>
        <!-- /page header -->
        ...
        <div class="content">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">{{ __('dashboard.view_sort_products') }} </h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                    ...
                    <tbody class="row_position">
                        @foreach ($objects as $object)
                            <tr parent_id="{{ $object->id }}">
                                <td>{{ $object->id }}</td>
                                <td><a
                                        href="/admin-panel/products/{{ $object->id }}/edit">{{ app()->getLocale() == 'ar' ? $object->title : $object->title_en }}</a>
                                </td>
                                <td>
                                    <div parent_id="{{ $object->id }}"><input class="input-sort"
                                            value="{{ $object->sort }}" /></div>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
    ...
    <script type="text/javascript">
        ...
        $(".input-sort").on('focusout', function() {
            $.ajax({
                url: "/admin-panel/change-sort-products",
                type: 'post',
                data: {
                    id: $(this).parent().attr('parent_id'),
                    sort: $(this).val(),
                    single: true
                },
                success: function() {}
