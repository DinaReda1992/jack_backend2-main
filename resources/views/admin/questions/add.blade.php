...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="/admin-panel/questions">عرض الأسئلة</a></li>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form method="post" class="form-horizontal" action="{{ isset($object)? '/admin-panel/questions/'.$object->id : '/admin-panel/questions'  }}">
								{!! csrf_field() !!}
									@if(isset($object))
