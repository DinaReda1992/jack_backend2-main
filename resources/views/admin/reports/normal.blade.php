						...
						<table class="table datatable-colvis-basic">
							...
							@foreach($objects as $object)
								<tr parent_id="{{ $object->id }}">
									...
									<td>
										<a href="/admin/users/adv_ads/{{ $object ->id }}">
									...
									<td align="center" class="center"> <ul class="icons-list">
												...
												<li class="text-danger-600"><a onclick="return false;" object_id="{{ $object->id }}" delete_url="/admin/ads/{{ $object->id }}"  class="sweet_warning" href="#"><i class="icon-trash"></i></a></li>
