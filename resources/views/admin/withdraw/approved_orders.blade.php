		...
		<div class="page-header">
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li class="active"><a href="">عرض الطلبات الموافق عليها</a></li>
				</ul>
		...
		<!-- Basic example -->
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">عرض الطلبات الموافق عليها</h5>
					<div class="heading-elements">
						<ul class="icons-list">
								...
								{{--<div class="modal fade" id="myModal{{ $object->id }}555" tabindex="-1" role="dialog"--}}
									...
									{{--<div class="modal-dialog" role="document">--}}
										{{--<div class="modal-content">--}}
											...
											{{--</div>--}}
											{{--<form method="get" action="/admin-panel/cancel_order/{{ $object ->id }}">--}}
