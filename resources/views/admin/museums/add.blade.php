...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="/admin-panel/museums">عرض المعارض</a></li>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form enctype="multipart/form-data"  method="post" class="form-horizontal" action="{{ isset($object)? '/admin-panel/museums/'.$object->id : '/admin-panel/museums'  }}">
								{!! csrf_field() !!}
									@if(isset($object))
