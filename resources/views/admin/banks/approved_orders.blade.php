				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم</span> -  عرض طلبات الفحص التي تم الموافقة عليها</h4>
						</div>
...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="">عرض طلبات الفحص التي تم الموافقة عليها</a></li>
						</ul>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">عرض طلبات الفحص التي تم الموافقة عليها</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<table class="table datatable-colvis-basic">
							...
							@foreach($objects as $object)
								<tr parent_id="{{ $object->id }}">
									...
									<td>
										<a href="/admin-panel/approve_payment/{{ $object ->id }}">
											<button type="button" name="button" class="btn btn-success"> تم دفع تكلفة الخدمة</button>
										</a>
									</td>
