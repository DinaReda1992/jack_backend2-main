...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="/admin-panel/screens">عرض الشاشات</a></li>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form method="post" class="form-horizontal" action="{{ isset($object)? '/admin-panel/screens/'.$object->id : '/admin-panel/screens'  }}" enctype="multipart/form-data">
								{!! csrf_field() !!}
									@if(isset($object))
