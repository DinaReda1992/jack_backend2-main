        ...
        <div class="page-header">
            <div class="page-header-content">
                <div class="page-title">
                    <h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">لوحة التحكم</span> -
                        عرض جميع طلبات المرفوض من السائق</h4>
                </div>
            </div>
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><a href="">عرض جميع طلبات المرفوض من السائق</a></li>
                </ul>
        ...
        <div class="content">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">عرض جميع طلبات المرفوض من السائق</h5>
                ...
                @include('admin.purchases.refused_orders_details', ['type' => 0])
