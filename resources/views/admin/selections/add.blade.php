        ...
        <div class="page-header">
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li><a href="/admin-panel/selections">عرض الخصائص</a></li>
                    @if(@$object)
                    <li><a href="/admin-panel/selections/{{ $object->id }}">التحكم في الاوبشنز</a></li>
                    @endif
            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <form enctype="multipart/form-data" method="post" class="form-horizontal"
                          action="{{ isset($object)? '/admin-panel/selections/'.$object->id : '/admin-panel/selections'  }}">
                        {!! csrf_field() !!}
                        @if(isset($object))
