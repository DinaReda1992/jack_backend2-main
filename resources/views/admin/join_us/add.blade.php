...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="/admin-panel/countries">عرض الدول</a></li>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form method="post" enctype="multipart/form-data" class="form-horizontal" action="{{ isset($object)? '/admin-panel/countries/'.$object->id : '/admin-panel/countries'  }}">
								{!! csrf_field() !!}
									@if(isset($object))
