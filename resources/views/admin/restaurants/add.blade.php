	...
	<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.add-advantage').click(function () {
                ...
                $.get('/hall-panel/extraFeatures',function (data) {
...
@section('content')
	...
	<div class="content-wrapper">
		...
		<!-- Content area -->
		<div class="content">
			<form method="post" class="form-horizontal" action="{{ isset($object)? '/hall-panel/halls/'.$object->id : '/hall-panel/halls'  }}" enctype="multipart/form-data">
				{!! csrf_field() !!}
				@if(isset($object))
									...
									<div class="col-lg-10">
										@foreach( \App\Models\HallPhoto::where('hall_id',$object->id)->get() as $photo)
											<div align="center" style="height: 75px;width: 100px;float: right;margin-right: 5px">
												...
												<a href="/hall-panel/delete-photo-hall/{{ $photo->id }}" style="text-align: center">حذف</a>
											</div>
										@endforeach
									</div>
