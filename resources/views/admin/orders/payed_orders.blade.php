				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">{{__('dashboard.dashboard')}}</span> -  عرض طلبات الفحص التي تم دفع تكلفتها </h4>
						</div>
...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="">عرض طلبات الفحص التي تم دفع تكلفتها </a></li>
						</ul>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">عرض طلبات الفحص التي تم دفع تكلفتها </h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<table class="table datatable-colvis-basic text-center">
							...
							@foreach($objects as $object)
								<tr parent_id="{{ $object->id }}">
									...
									<td><a href="/admin-panel/users/{{ $object->user_id  }}/edit" target="_blank">{{ $object->getUser ? $object->getUser->full_name()  : '_________' }}</a></td>
									<td><a href="/admin-panel/states/{{ $object->state_id  }}/edit" target="_blank">{{ $object->getState ? $object->getState->name  : 'لم يحدد مدينة' }}</a></td>
									<td>
										<a href="/admin-panel/on_progress_order/{{ $object ->id }}">
											<button type="button" name="button" class="btn btn-success"> تحويل الى جاري العمل</button>
										</a>
									</td>
									...
									{{--<td align="center" class="center"> <ul class="icons-list">--}}
												...
												{{--<li class="text-danger-600"><a onclick="return false;" object_id="{{ $object->id }}" delete_url="/admin-panel/projects/{{ $object->id }}"  class="sweet_warning" href="#"><i class="icon-trash"></i></a></li>--}}
												...
												<div class="row">
													<div  style="margin-top: 25px;" class="col-xs-12">
														<div class="orderInfo">
															<div class="row">
																<div class="col-xs-12">
																	<p style="font-weight: bold">1- {{__('messages.order-info-user')}} :</p>
																...
																<div class="col-xs-6">
																	<label style="margin-top: 50px;">{{__('dashboard.phone')}}</label>
																	<input class="form-control" type="tel" readonly value="+{{ @$object->getUser->phonecode }}{{ @$object->getUser->phone }}">
																</div>
																<div class="col-xs-6">
																	<label style="margin-top: 50px;">{{__('dashboard.email')}}</label>
