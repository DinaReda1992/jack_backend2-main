    ...
    <table class="table table-bordered text-center text-center">
        <thead>
            <tr>
                ...
                <th style="width: 200px"> {{ __('dashboard.action_taken') }}</th>
            </tr>
        </thead>
        <tbody>
            ...
            <td style="width: 127px">
                ...
                @else
                    <a href="{{ url('admin-panel/warehouse-details/' . $object->id) }}">
            ...
            @if ($object->status < 2)
                <td style="width: 200px;display:flex;" class="btns-group">
                    @if ($object->status == 0)
                        <a onclick="return false;" data-toggle="modal"
                            data-target="#approve_order{{ $object->id }}555" href="#" class="ml-2"
                            style="margin-left: 3px">
                            <button type="button" name="button" class="btn btn-primary m-2">
                                {{ __('dashboard.confirm_order') }}
                            </button>
                        </a>
                        <div class="modal fade" id="approve_order{{ $object->id }}555" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">{{ __('dashboard.confirm_order') }}
                                        </h4>
                                    </div>
                                    <form method="get" action="/admin-panel/approve_order/{{ $object->id }}">
                        ...
                        <a onclick="return false;" data-toggle="modal" class="ml-2" style="margin-left: 3px"
                            data-target="#cancelModal{{ $object->id }}555" href="#">
                            <button type="button" name="button" class="btn btn-danger btn-cancel ml-2">
            ...
            @if (in_array($object->status, [2]))
                <td style="width: 200px"  class="btns-group">
