        ...
        <div class="page-header">
            <div class="page-header-content">
                <div class="page-title">
                    <h4><i class="icon-arrow-right6 position-left"></i> <span
                        ...
                        {{ __('dashboard.view_all_drafts') }}</h4>
                </div>
            </div>
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><a href="">{{ __('dashboard.view_all_drafts') }}</a></li>
                </ul>
            </div>
        </div>
        <div class="content">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">{{ __('dashboard.view_all_drafts') }}</h5>
                ...
                <br>
                <form method="get" action="/admin-panel/orders">
                    <div class="row">
                ...
                @include('admin.orders.orders_details_drafts')
