		...
		<div class="page-header">
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="/admin-panel/stores">عرض المتاجر</a></li>
		...
		<!-- Form horizontal -->
			<div class="panel panel-flat">
				...
				<div class="panel-body">
					...
					<form enctype="multipart/form-data" method="post" class="form-horizontal" action="/admin-panel/import-excel">
						{!! csrf_field() !!}
						@if(isset($object))
		...
		<!-- Form horizontal -->
			<div class="panel panel-flat">
				...
				<div class="panel-body">
					...
					<form enctype="multipart/form-data" method="post" class="form-horizontal" action="{{ isset($object)? '/admin-panel/stores/'.$object->id : '/admin-panel/stores'  }}">
						{!! csrf_field() !!}
						@if(isset($object))
							<input type="hidden" name="_method" value="PATCH" />
						@endif
							...
							@if(isset($object->photo) && $object->photo )
								<div class="form-group">
									...
									<div class="col-lg-10">
										...
										<a href="/admin-panel/delete-photo-store/{{ $object->id }}">حذف الصورة</a>
									</div>
								</div>
							@endif
