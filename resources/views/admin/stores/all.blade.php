							...
							@foreach($objects as $object)
								<tr parent_id="{{ $object->id }}">
									...
									@if(@$object->approved==0)
										<a class="btn btn-success" href="/admin-panel/approve_store/{{ $object->id }}">موافقة على المتجر</a>
									@else
										تم الموافقة مسبقا
									@endif
									</td>
									...
									<td align="center" class="center"> <ul class="icons-list">
												<li class="text-danger-600"><a onclick="return false;" object_id="{{ $object->id }}" delete_url="/admin-panel/stores/{{ $object->id }}"  class="sweet_warning" href="#"><i class="icon-trash"></i></a></li>
