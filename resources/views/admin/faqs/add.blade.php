...
<!-- 						</div> -->
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="/admin-panel/faqs">عرض الاسئلة المكررة</a></li>
...
@include('admin.message')
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form method="post" class="form-horizontal" action="{{ isset($object)? '/admin-panel/faqs/'.$object->id : '/admin-panel/faqs'  }}">
								{!! csrf_field() !!}
									@if(isset($object))
