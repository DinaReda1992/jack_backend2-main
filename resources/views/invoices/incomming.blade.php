...
@section('title')
    <title>{{ \App\Models\Settings::find(5)->value }} - الفواتير الواردة </title>
...
@section('content')
    <div class="profile">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    @include('layouts.sidebar',['current'=>'incomming-invoices'])
                </div>
                <div class="col-md-9">
                    <div class="forms">
                        <div data-active=1 id="tab-b1" class="edit-your-info a-tab">
                            <h4 style="margin-bottom: 20px;color: #f14444;">الفواتير الواردة</h4>
                            <div class="my-prods">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            @if($invoice->status!=2)
                                                            <a  href="/product-delivered/{{ $invoice->id }}">
                                                                <button type="button" class="btn btn-primary">تم توصيل المنتجات</button>
                                                            </a>
                                                            @endif
                                                        </div>
                                                    </div>
