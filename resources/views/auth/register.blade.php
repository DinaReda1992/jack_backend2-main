                ...
                <div class="col-md-12">
                    <div class="page-head-con">
                        <ul class="d-inline-block">
                            ...
                            <li class="d-inline-block">تسجيل جديد </li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="email-login">
                    <div class="row">
                        <div class="col-12" >
                            ...
                            <input type="text" disabled value="{{isset($phone)?$phone:'0594455454'}}" class="form-control" >
                        ...
                        <div class="col-12 {{ $errors->has('username') ? ' has-error' : '' }}" >
                            ...
                            <input type="text" id="username" name="username" value="{{old('username')}}" required class="form-control" placeholder="الاسم بالكامل">
                        ...
                        <div class="col-12 col-md-6 {{ $errors->has('country_id') ? ' has-error' : '' }}">
                            ...
                            <select name="country_id" id="country_id" required>
                                ...
                                @foreach(\App\Models\Countries::all() as $country)
                                    <option {{old('country_id')&&old('country_id')==$country_id?'selected':($country->id==188?'selected':'')}} value="{{$country->id}}">{{$country->name}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <select  id="client_type" name="client_type" required>
                                ...
                                @foreach (\App\Models\ClientTypes::all() as $shopType)
                                    <option value="{{ old('client_type') }}"  {{ old('client_type') == $shopType->id ? 'selected' : '' }}>  {{$shopType->name}} </option>
                        ...
                        <div class="col-12 col-md-6 {{ $errors->has('state_id') ? ' has-error' : '' }}">
                            ...
                            <input type="email" id="email" value="{{old('email')}}" placeholder="البريد الالكترونى" name="email">
                            @if ($errors->has('email'))
                                <span class="help-block">
                        ...
                        <div class="col-12 col-md-6 {{ $errors->has('commercial_no') ? ' has-error' : '' }}">
                            ...
                            <input type="number" id="commercial_no" value="{{old('commercial_no')}}" placeholder="رقم السجل التجارى" name="commercial_no">
                        ...
                        <div class="col-12 col-md-6 {{ $errors->has('commercial_end_date') ? ' has-error' : '' }}">
                            ...
                            <input type="text" id="commercial_end_date" value="{{old('commercial_end_date')}}" placeholder="تاريخ انتهاء السجل التجارى" name="commercial_end_date">
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <input type="password" id="password" placeholder="الرقم السري" name="psw" required>
                        </div>
                        <div class="col-md-6 col-12">
                            <label for="confirm-pass"><b>اعادة الرقم السري</b></label>
                            <input type="password" id="confirm-pass" placeholder="الرقم السري" name="confirm-pass" required>
                        </div>
                        <div class="col-12">
