...
class BanksController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware(function ($request, $next) {
            $this->check_settings(243);
            return $next($request);
        });
    }
    public function index()
    {
        return view('admin.banks.all',['objects'=>Banks::all()]);
    }
    ...
    {
        return view('admin.banks.add',['countries'=>Countries::all()]);
    }
    ...
    {
    	return view('admin.banks.add',['object'=> Banks::find($id),'countries'=>Countries::all()]);
    }
