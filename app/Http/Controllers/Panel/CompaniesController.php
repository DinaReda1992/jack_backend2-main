...
class CompaniesController extends Controller
{
    ...
    {
        return view('admin.companies.all',['objects'=>Companies::all()]);
    }
    ...
    {
        return view('admin.companies.add',['users'=> User::all()]);
    }
    ...
    {
    	return view('admin.companies.add',['object'=> Companies::find($id) , 'users' => User::all() ]);
    }
