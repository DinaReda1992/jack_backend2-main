...
class CitiesController extends Controller
{
    ...
    {
        return view('admin.cities.all',['objects'=>Cities::all() ]);
    }
    ...
    {
        return view('admin.cities.add',[ 'states'=>States::all() ]);
    }
    ...
    {
    	return view('admin.cities.add',['object'=> Cities::find($id), 'states'=>States::all() ]);
    }
