...
class MeasurementUnitController extends Controller
{
    ...
    {
        return view('admin.measurement-units.all',['objects'=>MeasurementUnit::all()]);
    }
    ...
    {
        return view('admin.measurement-units.add');
    }
...
//                MeasurementUnitRestaurants::where('category_id',$object->id)->delete();
    ...
    {
        return view('admin.measurement-units.subs',['objects'=>MeasurementUnit::where('parent_id',$id)->orderBy('sort','asc')->get(),'category'=>Categories::find($id)]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.measurement-units.add',['object'=> $object]);
    }
