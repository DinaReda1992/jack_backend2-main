...
class ReportsController extends Controller
{
    ...
    {
        return view('admin.reports.all',['objects'=>Reports::all()]);
    }

    public function projects()
    {
        return view('admin.reports.ads',['objects'=>Reports::where('type',0)->orderBy('id','DESC')->get()]);
    }

    public function comments()
    {
        return view('admin.reports.comments',['objects'=>Reports::where('type',1)->get()]);
    }

    public function normal_ads()
    {
        return view('admin.reports.normal',['objects'=>Reports::where('adv',0)->get()]);
    }
    ...
    {
        return view('admin.reports.add',['object'=> Reports::find($id)]);
    }
