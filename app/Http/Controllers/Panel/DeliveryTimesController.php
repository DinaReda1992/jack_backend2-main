...
class DeliveryTimesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.delivery-times.all',['objects'=>$categories]);
    }
    ...
    {
        return view('admin.delivery-times.add');
    }
...
//         $object->description = $request->description;
    ...
    {
    	return view('admin.delivery-times.add',['object'=> DeliveryTimes::find($id)]);
    }
