...
class BlogSubcategoriesController extends Controller
{
    ...
    {
        return view('admin.blog-subcategories.all',['objects'=>BlogSubcategories::all() ]);
    }
    ...
    {
        return view('admin.blog-subcategories.add',[ 'categories'=>BlogCategories::all() ]);
    }
    ...
    {
    	return view('admin.blog-subcategories.add',['object'=> BlogSubcategories::find($id), 'categories'=>BlogCategories::all() ]);
    }
