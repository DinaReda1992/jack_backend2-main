...
class MrmandoobCardsController extends Controller
{
    ...
    {
        return view('admin.mrmandoob-cards.all', ['objects' => MrmandoobCards::orderBy('id', 'DESC')->get()]);
    }
    ...
    {
        return view('admin.mrmandoob-cards.add');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.mrmandoob-cards.details', ['objects' => $cards, 'card_name' => $card_name->name ,'card'=>$card_name]);
    }
    ...
    {
        return view('admin.mrmandoob-cards.add', ['object' => MrmandoobCards::find($id)]);
    }
