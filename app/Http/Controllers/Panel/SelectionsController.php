...
class SelectionsController extends Controller
{
    ...
    {
        return view('admin.selections.all',['objects'=>Selections::orderBy('sort','asc')->get()]);
    }

    public function selections()
    {
        return view('admin.selections.all',['objects'=>Selections::where('parent_id',0)->orderBy('sort','asc')->get()]);
    }
    ...
    {
        return view('admin.selections.add');
    }
...
//         $object->name_en = $request->name_en;
    ...
    {
        return view('admin.selections.subs',['objects'=>SelectionOptions::where('selection_id',$id)->orderBy('sort','asc')->get(),'selection'=>Selections::find($id)]);
    }
    ...
    {
    	return view('admin.selections.add',['object'=> Selections::find($id)]);
    }
