...
class QuestionsController extends Controller
{
    ...
    {
        return view('admin.questions.all',['objects'=>Questions::all() ]);
    }
    ...
    {
        return view('admin.questions.add',[ 'categories'=>Categories::all() ]);
    }
    ...
    {
    	return view('admin.questions.add',['object'=> Questions::find($id), 'categories'=>Categories::all() ]);
    }
