...
class IllustrationsController extends Controller
{
    ...
    {
        return view('admin.illustrations.all',['objects'=>Illustrations::orderBy('sort','asc')->get()]);
    }
    ...
    {
        return view('admin.illustrations.add');
    }
...
//		 $object->description = $request->description;
    ...
    {
    	return view('admin.illustrations.add',['object'=> Illustrations::find($id)]);
    }
