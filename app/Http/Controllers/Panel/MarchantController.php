...
class MarchantController extends Controller
{
    ...
    {
        return view('admin.marchant.all',['objects'=>Marchant::all()]);
    }
    ...
    {
        return view('admin.marchant.add',['users'=> User::all()]);
    }
    ...
    {
    	return view('admin.marchant.add',['object'=> Marchant::find($id) , 'users' => User::all() ]);
    }
