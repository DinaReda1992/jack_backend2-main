...
class AdvantagesController extends Controller
{
    ...
    {
        return view('providers.advantages.all',['objects'=>Advantages::all()]);
    }
    ...
    {
        return view('providers.advantages.add');
    }
    ...
    {
    	return view('providers.advantages.add',['object'=> Advantages::find($id)]);
    }
