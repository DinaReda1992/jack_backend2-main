...
class RepresentativesController extends Controller
{
    ...
    {
        return view('providers.representatives.all', ['objects' => RequestRepresentative::where('status',0)->orderBy('id','DESC')->paginate(50)]);
    }

    public function cancelled_requests()
    {
        return view('providers.representatives.cancelled', ['objects' => RequestRepresentative::where('status',2)->orderBy('id','DESC')->paginate(50)]);
    }
    ...
    {
        return view('providers.banks.new_transfer_member', ['objects' => BankTransfer::where('type', "membership")->orderBy('id', 'DESC')->get()]);
    }

    public function new_orders()
    {
        return view('providers.representatives.new_orders', ['objects' => Orders::where('status', 0)->orderBy('id', 'DESC')->paginate(50)]);
    }

    public function cancelled_orders()
    {
        return view('providers.representatives.cancelled_orders', ['objects' => Orders::where('status', 2)->orderBy('id', 'DESC')->get()]);
    }

    public function approved_orders()
    {
        return view('providers.representatives.approved_orders', ['objects' => Orders::where('status', 1)->orderBy('id', 'DESC')->get()]);
    }

    public function payed_orders()
    {
        return view('providers.representatives.payed_orders', ['objects' => Orders::where('status', 2)->orderBy('id', 'DESC')->get()]);
    }

    public function on_progress_orders()
    {
        return view('providers.representatives.on_progress_orders', ['objects' => Orders::where('status', 3)->orderBy('id', 'DESC')->get()]);
    }

    public function done_orders()
    {
        return view('providers.representatives.done_orders', ['objects' => Orders::where('status', 4)->orderBy('id', 'DESC')->get()]);
    }


    public function normal_ads()
    {
        return view('providers.representatives.normal', ['objects' => Orders::where('adv', 0)->get()]);
    }
...
//        }
    ...
    {
        return view('providers.representatives.ask_orders', ['objects' => OrdersOrders::all()]);
    }
    ...
    {
        return view('providers.representatives.add');
    }
    ...
    {
        return view('providers.representatives.add', ['object' => Orders::find($id)]);
    }
