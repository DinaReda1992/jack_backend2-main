...
class InvoicesController extends Controller
{
    ...
    {
        return view('providers.invoices.all', ['objects' => Invoices::orderBy('id','DESC')->get()]);
    }
    ...
    {
        return view('providers.invoices.new_orders', ['objects' => Invoices::where('status', 0)->orderBy('id', 'DESC')->get()]);
    }

    public function cancelled_orders()
    {
        return view('providers.invoices.cancelled_orders', ['objects' => Invoices::where('status', 2)->orderBy('id', 'DESC')->get()]);
    }

    public function approved_orders()
    {
        return view('providers.invoices.approved_orders', ['objects' => Invoices::where('status', 1)->orderBy('id', 'DESC')->get()]);
    }

    public function payed_orders()
    {
        return view('providers.invoices.payed_orders', ['objects' => Invoices::where('status', 2)->orderBy('id', 'DESC')->get()]);
    }

    public function on_progress_orders()
    {
        return view('providers.invoices.on_progress_orders', ['objects' => Invoices::where('status', 3)->orderBy('id', 'DESC')->get()]);
    }

    public function done_orders()
    {
        return view('providers.invoices.done_orders', ['objects' => Invoices::where('status', 4)->orderBy('id', 'DESC')->get()]);
    }


    public function normal_ads()
    {
        return view('providers.invoices.normal', ['objects' => Invoices::where('adv', 0)->get()]);
    }
...
//        }
    ...
    {
        return view('providers.invoices.ask_orders', ['objects' => OrdersInvoices::all()]);
    }
    ...
    {
        return view('providers.invoices.add');
    }
    ...
    {
        return view('providers.invoices.add', ['object' => Invoices::find($id)]);
    }
