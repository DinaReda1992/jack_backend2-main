...
class StoresController extends Controller
{
    ...
    {
        return view('providers.stores.all',['objects'=>Stores::orderBy('id','DESC')->get()]);
    }
    ...
    {
        return view('providers.stores.add');
    }
...
//            'photo' => 'required',
    ...
    {
    	return view('providers.stores.add',['object'=> Stores::find($id) ]);
    }
