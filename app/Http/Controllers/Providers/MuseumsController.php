...
class MuseumsController extends Controller
{
    ...
    {
        return view('providers.museums.all',['objects'=>Museums::all()]);
    }
    ...
    {
        return view('providers.museums.add',['users'=> User::all()]);
    }
    ...
    {
    	return view('providers.museums.add',['object'=> Museums::find($id) , 'users' => User::all() ]);
    }
