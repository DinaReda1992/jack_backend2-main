...
class ProjectsController  extends Controller
{
    ...
    {
        return view('providers.projects.all',['objects'=>Projects::orderBy('id','DESC')->get()]);
    }

    public function new_projects()
    {
        return view('providers.projects.new_projects',['objects'=>Projects::where('status',0)->orderBy('id','DESC')->get()]);
    }

    public function approved_projects()
    {
        return view('providers.projects.approved_projects',['objects'=>Projects::where('status',1)->orderBy('id','DESC')->get()]);
    }

    public function cancelled_projects()
    {
        return view('providers.projects.cancelled_projects',['objects'=>Projects::where('status',2)->orderBy('id','DESC')->get()]);
    }

    public function normal_ads()
    {
        return view('providers.projects.normal',['objects'=>Projects::where('adv',0)->get()]);
    }
    ...
    {
      return view('providers.projects.ask_orders',['objects'=>AdsOrders::all()]);
    }
    ...
    {
        return view('providers.projects.add');
    }
    ...
    {
    	return view('providers.projects.add',['object'=> Projects::find($id)]);
    }
