...
class MainSliderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("providers.sliders.main.all")->with("objects",$categories);
    }
    ...
    {
        return view('providers.sliders.main.add');
    }
    public function edit($id)
    {
        return view('providers.sliders.main.add',['object'=> Main_slider::find($id)]);
    }
