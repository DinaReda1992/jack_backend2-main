...
class ContactsController extends Controller
{
    ...
    {
        return view('providers.contacts.all',['objects'=>Contacts::orderBy('id','DESC')->get()]);
    }
    ...
    {
      return view('providers.contacts.ask_orders',['objects'=>Contacts::where('status',0)->orderBy('id','DESC')->get()]);
    }
