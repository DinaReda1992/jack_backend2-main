...
class BannersController extends Controller
{
    ...
    {
        return view('providers.banners.all',['objects'=>Banners::orderBy('sort','asc')->get()]);
    }
    ...
    {
        return view('providers.banners.add');
    }
    ...
    {
    	return view('providers.banners.add',['object'=> Banners::find($id)]);
    }
