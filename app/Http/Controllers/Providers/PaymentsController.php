...
class PaymentsController extends Controller
{
    ...
    {
        return view('providers.payments.all', ['objects' => Payments::orderBy('id','DESC')->paginate(50)]);
    }


    public function new_payments()
    {
        return view('providers.payments.payments', ['objects' => Payments::where('status',0)->orderBy('id','DESC')->paginate(50)]);
    }
    ...
    {
        return view('providers.payments.new_orders', ['objects' => Orders::where('status', 0)->orderBy('id', 'DESC')->paginate(50)]);
    }

    public function cancelled_orders()
    {
        return view('providers.payments.cancelled_orders', ['objects' => Orders::where('status', 2)->orderBy('id', 'DESC')->get()]);
    }

    public function approved_orders()
    {
        return view('providers.payments.approved_orders', ['objects' => Orders::where('status', 1)->orderBy('id', 'DESC')->get()]);
    }

    public function payed_orders()
    {
        return view('providers.payments.payed_orders', ['objects' => Orders::where('status', 2)->orderBy('id', 'DESC')->get()]);
    }

    public function on_progress_orders()
    {
        return view('providers.payments.on_progress_orders', ['objects' => Orders::where('status', 3)->orderBy('id', 'DESC')->get()]);
    }

    public function done_orders()
    {
        return view('providers.payments.done_orders', ['objects' => Orders::where('status', 4)->orderBy('id', 'DESC')->get()]);
    }


    public function normal_ads()
    {
        return view('providers.payments.normal', ['objects' => Orders::where('adv', 0)->get()]);
    }
...
//        }
    ...
    {
        return view('providers.payments.ask_orders', ['objects' => OrdersOrders::all()]);
    }
    ...
    {
        return view('providers.payments.add');
    }
    ...
    {
        return view('providers.payments.add', ['object' => Orders::find($id)]);
    }
