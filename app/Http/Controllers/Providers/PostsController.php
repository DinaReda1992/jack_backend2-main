...
class PostsController extends Controller
{
    ...
    {
        return view('providers.posts.all', ['objects' => Posts::all()]);
    }
    ...
    {
        return view('providers.posts.new_posts', ['objects' => Posts::where('status', 0)->orderBy('id', 'DESC')->get()]);
    }

    public function cancelled_posts()
    {
        return view('providers.posts.cancelled_posts', ['objects' => Posts::where('status', 2)->orderBy('id', 'DESC')->get()]);
    }

    public function approved_posts()
    {
        return view('providers.posts.approved_posts', ['objects' => Posts::where('status', 1)->orderBy('id', 'DESC')->get()]);
    }
...
//        }
    ...
    {
        return view('providers.posts.ask_orders', ['objects' => PostsPosts::all()]);
    }
    ...
    {
        return view('providers.posts.add');
    }
    ...
    {
        return view('providers.posts.add', ['object' => Posts::find($id)]);
    }
