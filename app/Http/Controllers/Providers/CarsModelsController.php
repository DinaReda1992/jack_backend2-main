...
class CarsModelsController extends Controller
{
    ...
    {
        return view('providers.carsmodels.all',['objects'=>CarsModels::all() ]);
    }
    ...
    {
        return view('providers.carsmodels.add',[ 'cars'=>Cars::all()]);
    }
    ...
    {
    	return view('providers.carsmodels.add',['object'=> CarsModels::find($id), 'cars'=>Cars::all()]);
    }
