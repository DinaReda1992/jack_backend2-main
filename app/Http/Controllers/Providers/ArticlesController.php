...
class ArticlesController extends Controller
{
    ...
    {
        return view('providers.articles.all',['objects'=>Articles::all()]);
    }

    public function adv_adss()
    {
        return view('providers.articles.adv',['objects'=>Articles::where('adv',1)->get()]);
    }

    public function normal_ads()
    {
        return view('providers.articles.normal',['objects'=>Articles::where('adv',0)->get()]);
    }
    ...
    {
      return view('providers.articles.ask_orders',['objects'=>AdsOrders::all()]);
    }
    ...
    {
        return view('providers.articles.add');
    }
    ...
    {
    	return view('providers.articles.add',['object'=> Articles::find($id)]);
    }
