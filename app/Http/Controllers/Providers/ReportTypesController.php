...
class ReportTypesController extends Controller
{
    ...
    {
        return view('providers.report-types.all',['objects'=>ReportTypes::all()]);
    }
    ...
    {
        return view('providers.report-types.add');
    }
    ...
    {
    	return view('providers.report-types.add',['object'=> ReportTypes::find($id)]);
    }
