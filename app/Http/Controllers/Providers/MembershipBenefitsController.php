...
class MembershipBenefitsController extends Controller
{
    ...
    {
        return view('providers.membership_benefits.all',['objects'=>MembershipBenefits::all()]);
    }


    public function create()
    {
        return view('providers.membership_benefits.add');
    }
    ...
    {
    	return view('providers.membership_benefits.add',['object'=> MembershipBenefits::find($id)]);
    }
