...
class BlocksController extends Controller
{
    ...
    {
        return view('providers.blocks.all',['objects'=>Blocks::all() ]);
    }
    ...
    {
        return view('providers.blocks.add',[ 'cities'=>Cities::all() ]);
    }
    ...
    {
    	return view('providers.blocks.add',['object'=> Blocks::find($id), 'cities'=>Cities::all() ]);
    }
