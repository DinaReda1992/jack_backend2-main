...
class CountriesController extends Controller
{
    ...
    {
        return view('providers.countries.all',['objects'=>Countries::all()]);
    }
    ...
    {
        return view('providers.countries.add');
    }
    ...
    {
    	return view('providers.countries.add',['object'=> Countries::find($id)]);
    }
