(function($) {
      ...
      processSticky: function() {
        ...
        $(".header-sticky .sticky-area").each(function() {
          ...
          if (sticky_current_top - sticky_top < current_scroll_top) {
            ...
            $(".logo-sticky").addClass("d-flex");
            $(".icons-sticky").addClass("d-flex");
            ...
            if ($wrap.hasClass("sticky")) {
              ...
              $(".logo-sticky").removeClass("d-flex");
              $(".icons-sticky").removeClass("d-flex");
  ...
  $(".product .btn").click(function() {
    ...
    // $(".product .btn").not(this).css("background", "green")
  });
  ...
  // });
  $(document).ready(function() {
    $("#headingIngredients").click(function() {
      $(this)
        .next("#ingredients")
        .slideToggle("fast");
      var child = $(".iconn", this);
      child.toggleClass("font-hide");
    });
  
    $("#headingProductDetail").on("click", function() {
      $(this)
        .next("#product-detail")
        .slideToggle("fast");
  ...
  $(".selectalll").click(function() {
    $(".individuall").prop("checked", $(this).prop("checked"));
  });
  // addresses menu 
  
  $(".btn.dropdown-toggle-split").click(function() {
  ...
  $(".toggle").click(function(e) {
    ...
    if ($this.next().hasClass("show")) {
      $(".primary-summary-inner").css("position", "static");
      // $('.primary-summary-inner').css('bottom', '10px');
      // $('.primary-summary-inner').css('top', 'auto');
      $(".primary-summary-inner").removeClass("sticky");
  ...
  $(document).ready(function() {
    $("#keyword").click(function() {
      var docClick = function(ev) {
        if (!$(ev.target).hasClass("srchinput")) {
          closeDropdown();
        }
      };
  
      var closeDropdown = function() {
        $(".dropdown-menu.srch").removeClass("show-menu");
        $(document).unbind("click", docClick);
      };
  
      if ($(".dropdown-menu.srch").hasClass("show-menu")) {
        closeDropdown();
      } else {
        $(document).bind("click", docClick);
        $(".dropdown-menu.srch").addClass("show-menu");
      }
  
      $(".dropdown-menu.srch > li").click(function() {
        closeDropdown();
      });
      $(".dropdown-menu.srch.dropdown-select > li").click(function() {
        $(".srchinput").html($(this).html());
      });
    });
  });
  ...
  $("#keyword").on("keyup", function() {
    ...
    if (query != "") {
      ...
      $.ajax({
        ...
        method: "POST",
        data: { query: query, mobile: 1, _token: _token },
